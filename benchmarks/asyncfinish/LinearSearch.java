...
public class LinearSearch {
    ...
    public static void loop_body(final Object[] arrayToSearch, final AtomicBoolean resultObject) {
        for (int j = 0; j < arrayToSearch.length; j++) {
            if (LSConfiguration.itemFoundPredicate(arrayToSearch, j)) {
                resultObject.set(true);
            }
        }
    }
    ...
    public static void runIteration() {
        ...
        final AtomicBoolean resultObject = new AtomicBoolean();
        finish{
            async {
