...
public class UTS {
    ...
    private void findElement(final Object loopQueue) {
        ...
        while (!workingCopy.isEmpty()) {
            ...
            processPendingNodes(workingCopy);
        }
    }
    ...
    private void processPendingNodes_wrapper(Object[] queues) {
        async {
          for (int i=0; i<queues.length; i++) { 
            findElement(queues[i]);
          }
        }
    }

    private void processPendingNodes(final Queue<Node> workingCopy) {
